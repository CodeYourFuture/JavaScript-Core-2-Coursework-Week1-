...
/* Because the value of "this" is evaluated it at runtime: 1.the function can be used inside different objects. 2. "this" has no value until the fucntion is called.
  3. if we use 'bottle' and reassign the variable to another name then when we run the function we will be calling something totally different.*/
/*
